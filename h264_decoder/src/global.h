...
//buffer sizes
#define MAXNALBUFFERSIZE 2450 //200000
#define MAXSPSSIZE 5
...
#ifndef PicWidthInMBs
#define PicWidthInMBs 11   // QCIF
#endif

#define PicWidthInSamplesL (PicWidthInMBs*16)
#define PicWidthInSamplesC	(PicWidthInMBs*MbWidth_C)

#ifndef FrameHeightInMbs
#define FrameHeightInMbs 9   // QCIF
#endif
...
unsigned char *nz_coeff_chroma_ptr;
unsigned char (*nz_coeff_chroma)[PicWidthInMBs*2][FrameHeightInMbs*2];
#else
