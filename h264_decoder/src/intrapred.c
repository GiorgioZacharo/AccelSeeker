    ...
    int starty)
{
  ...
  for(k=0;k<16;k++)
  {
    ...
    previntramodeflag=u_1(nalu,nalu_buf, nalu_bit_offset);
#if _N_HLS_
    ...
    {
      tmpintramode[k]=u_n(3,nalu,nalu_buf, nalu_bit_offset);
#if _N_HLS_
...
#pragma SDS data access_pattern(Sluma:RANDOM)
#pragma SDS data mem_attribute(Sluma:PHYSICAL_CONTIGUOUS)
#pragma SDS data zero_copy(Sluma[0:PicWidthInSamplesL][0:FrameHeightInSampleL])
...
//  v5 0 0 0 0
//  v6 0 0 0 0
#pragma SDS data access_pattern(SChroma:RANDOM)
#pragma SDS data mem_attribute(SChroma:PHYSICAL_CONTIGUOUS)
#pragma SDS data zero_copy(SChroma[0:PicWidthInSamplesC][0:FrameHeightInSampleC])
